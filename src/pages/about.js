...
export default function about() {
  return (
    <div className="container flim-bg">
      <div className="row justify-content-center">
        <div className="col-md-7 my-4 aboutus-detail">
          <div className="text-center">
            <h3 className="my-2 mb-4 ">About Us</h3>
          ...
          <p className="my-4">
            Our platform offers a vast collection of films across multiple
            genres and languages, carefully curated to ensure there’s something
            for everyone. From personalized recommendations based on your
            viewing habits to expertly crafted playlists, we’re here to help you
          ...
          <p className="my-4">
            ...
            you want to stay updated with the latest releases or explore hidden
            gems, our app offers an immersive experience for every film
            enthusiast.
          </p>
          <p className="my-4">
          ...
          <p className="my-4">
            This version keeps it concise while highlighting your platform’s
            offerings. Let me know if you’d like any adjustments!
          </p>
        </div>
      </div>
    </div>
